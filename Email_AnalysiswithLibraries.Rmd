...
null_tdm<-TermDocumentMatrix(PQCorp.stems,control =list(weighting = function(x) weightSMART(x, spec = "btc")))
...
TODO: There is definitely something wrong about the way things line up. There emails in cluster 17 do not correspond to the top dozen words. 
