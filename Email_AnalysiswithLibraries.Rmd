...
summary(raw_data)
class(raw_data)
#rename the columns of the text and recipients
colnames(raw_data)
...
TODO: this is tricky as we haven't defined this yet - so i will no use the who function, just pull out the bigrams for the whole corpus.
